...
namespace go.Forms
{
    public class MainForm : Form
    {
        ...
        this.columnHeader44
            ...
            //this.notifyIconGO.Icon = Resources.Car;
        ...
        private static void Main()
        {
            ...
            ServicePointManager.ServerCertificateValidationCallback += (RemoteCertificateValidationCallback)((o, certificate, chain, errors) => true);
        ...
        private void LoadTracks()
        {
            try
            {
                BinaryFormatter binaryFormatter = new BinaryFormatter();
                binaryFormatter.Binder = (SerializationBinder)new TypeBinder();
                Stream serializationStream = (Stream)new FileStream("tracks.dat", FileMode.Open, FileAccess.Read, FileShare.Read);
            ...
            this.statusBarPanel3.Text = "tracks loaded";
        }
...
label_10:
        ...
        private bool Check(int verInfo, MatchCollection valuesMatch, int value)
        {
            return int.Parse(valuesMatch[verInfo].Groups["val"].Value) <= value;
        }
        ...
        private void CheckVersion()
        {
            ...
            bool flag = true;
            switch (valuesMatch.Count)
            {
                case 1:
                    flag = this.Check(0, valuesMatch, Datas.Version.Major);
                    break;
                case 2:
                    flag = this.Check(0, valuesMatch, Datas.Version.Major) && this.Check(1, valuesMatch, Datas.Version.Minor);
                    break;
                case 3:
                    flag = this.Check(0, valuesMatch, Datas.Version.Major) && this.Check(1, valuesMatch, Datas.Version.Minor) && this.Check(2, valuesMatch, Datas.Version.Build);
                    break;
                case 4:
                    flag = this.Check(0, valuesMatch, Datas.Version.Major) && this.Check(1, valuesMatch, Datas.Version.Minor) && this.Check(2, valuesMatch, Datas.Version.Build) && this.Check(3, valuesMatch, Datas.Version.Revision);
                    break;
            }
            if (flag)
            {
