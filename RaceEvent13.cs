...
namespace go
{
  ...
  public class RaceEvent13
  {
    ...
    public RaceEvent13(RaceEvent12 oldEvent)
    {
      ...
      this.race = new Race7(oldEvent.race);
    ...
    public RaceEvent13(RaceEvent11 oldEvent)
      : this(new RaceEvent12(oldEvent))
    {
    }

    public RaceEvent13(RaceEvent10 oldEvent)
      : this(new RaceEvent11(oldEvent))
    {
    }

    public RaceEvent13(RaceEvent9 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent13(RaceEvent8 oldEvent)
      : this(new RaceEvent9(oldEvent))
    {
    }

    public RaceEvent13(RaceEvent7 oldEvent)
      : this(new RaceEvent8(oldEvent))
    {
    }

    public RaceEvent13(RaceEvent6 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent13(RaceEvent5 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent13(RaceEvent4 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent13(RaceEvent3 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent13(RaceEvent2 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent13(RaceEvent oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }
  }
