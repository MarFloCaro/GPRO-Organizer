...
namespace go
{
  ...
  public class RaceEvent12
  {
    ...
    public RaceEvent12(RaceEvent11 oldEvent)
    {
      ...
      this.isTyreSupplierUpdated = false;
    }

    public RaceEvent12(RaceEvent10 oldEvent)
      : this(new RaceEvent11(oldEvent))
    {
    }

    public RaceEvent12(RaceEvent9 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent12(RaceEvent8 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent12(RaceEvent7 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent12(RaceEvent6 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent12(RaceEvent5 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent12(RaceEvent4 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent12(RaceEvent3 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent12(RaceEvent2 oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }

    public RaceEvent12(RaceEvent oldEvent)
      : this(new RaceEvent10(oldEvent))
    {
    }
  }
