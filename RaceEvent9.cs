...
namespace go
{
  ...
  public class RaceEvent9
  {
    ...
    public RaceEvent9(RaceEvent8 oldEvent)
    {
    ...
    public RaceEvent9(RaceEvent7 oldEvent)
      : this(new RaceEvent8(oldEvent))
    {
    }

    public RaceEvent9(RaceEvent6 oldEvent)
      : this(new RaceEvent8(oldEvent))
    {
    }

    public RaceEvent9(RaceEvent5 oldEvent)
      : this(new RaceEvent8(oldEvent))
    {
    }

    public RaceEvent9(RaceEvent4 oldEvent)
      : this(new RaceEvent8(oldEvent))
    {
    }

    public RaceEvent9(RaceEvent3 oldEvent)
      : this(new RaceEvent8(oldEvent))
    {
    }

    public RaceEvent9(RaceEvent2 oldEvent)
      : this(new RaceEvent8(oldEvent))
    {
    }

    public RaceEvent9(RaceEvent oldEvent)
      : this(new RaceEvent8(oldEvent))
    {
    }
  }
